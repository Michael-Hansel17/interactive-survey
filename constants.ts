...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    id: 'Nomor Telepon',
    text:
      'Senang kenal {{firstName}}! Boleh minta nomor telepon (atau WhatsApp) kamu biar Sheepy bisa follow-up ya 📱',
    type: 'text',
    placeholder: 'e.g., 081234567890',
    inputProps: {
      inputMode: 'tel',
  ...
  },
  {
    id: 'Tempat Kuliah',
    text:
      '{{firstName}}, kamu lagi kuliah di mana, atau udah kerja? (Tuliskan nama kampus atau tempat kerja)',
    type: 'text',
    placeholder: 'e.g., Universitas Pradita / Bekerja di Tokopedia',
    inputProps: { inputMode: 'text' },
    required: true,
